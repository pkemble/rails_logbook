...
ActiveRecord::Schema.define(version: 2021_02_01_024040) do
  ...
  create_table "aircraft", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "tail"
    t.string "ac_model"
  ...
  create_table "flights", id: :integer, charset: "utf8", force: :cascade do |t|
    t.text "dep"
    t.text "arr"
    t.string "blockin"
    t.string "blockout"
  ...
  create_table "psi_imports", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "dep"
    t.string "arr"
    t.text "tail"
    t.integer "dto"
