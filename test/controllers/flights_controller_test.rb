...
#    get :new
#    assert_response :found || :success
#  end
#
#  test "should create flight" do
#    assert_difference('Flight.count') do
#      post :create, flight: { dep: "fll", arr: "mdw", blockout: "1500", blockin: "1800", entry_id: @entry.id }
#    end
#
...
#    assert_redirected_to edit_entry_path(assigns(@entry.id))
#  end
#
